...
var sheet = Spreadsheet.fromURL("https://spreadsheets.google.com/pub?key=0AkUwNDE9ftXvdGMxQ2hMS2oySG9HeV9OeUtkZ2xoM1E&hl=en&output=html")

// https://spreadsheets.google.com/feeds/worksheets/{key}/public/values
sheet.worksheets(function(err,ws){
	ws.eachRow(function(err,row){

	})
	ws.eachCell(function(err,cell){
...
sheet.worksheet(id,function(err,ws){
  // https://spreadsheets.google.com/feeds/list/{key}/{id}/public/values
	ws.eachRow(function(err,row,meta){
    row = {name:"a",sector:"Culture"} // each //entry/gsx:* is converted to an object
    meta = {index:0,total:20,updated:new Date("2011-02-03T18:38:12.479Z"),id:"https://spreadsheets.google.com/feeds/list/0AkUwNDE9ftXvdGMxQ2hMS2oySG9HeV9OeUtkZ2xoM1E/od6/public/values/cokwr"}
	})

  // https://spreadsheets.google.com/feeds/cells/{key}/{id}/public/values
	ws.eachCell(function(err,cell,meta){
    
	})
})

// Using the worksheet page number
...
Spreadsheet.prototype.worksheets = function(fn){
  ...
  return this.load(function(err,atom){
    ...
    atom.entry.forEach(function(entry,i){
...
Spreadsheet.fromURL = function(url){
  var key = (require("url").parse(url).query||{}).key;
